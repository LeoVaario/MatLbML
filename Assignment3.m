...
HU = 90;  % the number of hidden neurons (Changeable)
...
EPOCH=10;  % The number of training epochs
DECAYING_R = 0.1; %Decaying rate
LAMBDA=0.01 / (1 + DECAYING_R * EPOCH); % learning rate
MINI_BATCH_SIZE = 100;
